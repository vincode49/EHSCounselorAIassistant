...
2. **Otherwise, calculate from graduation year** using the formula below

**Grade Calculation (Current School Year 2026-2027):**
- Use the current graduating class as **Class of 2027**
- **Formula (only if Current Grade is not provided):** Current Grade = 12 - (Graduation Year - 2027)

**CRITICAL: Always use the "Current Grade" from User Context if provided - it's the most accurate and may differ from calculated grade!**
...
- Be helpful and transparent about your sources
...
print("  - Use 2026-2027 counselor instructions")
print("  - Cite sources when students request them")
